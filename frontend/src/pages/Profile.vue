                ...
                <div class="flex flex-col md:flex-row items-center gap-8">
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <span class="text-5xl font-black text-teal-500">N</span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 w-full md:w-auto">
                        <div
                            ...
                            <p class="text-2xl font-black text-teal-500">{{'10k' }}</p>
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">likes</p>
                        </div>
                        <div
                            class="bg-white dark:bg-[#1e293b] p-6 rounded-3xl border border-slate-200 dark:border-slate-700/50 text-center">
                            <p class="text-2xl font-black text-teal-500">99+</p>
                ...
                <article
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-slate-600 dark:text-slate-400 mb-6 line-clamp-2 leading-relaxed italic">
                           Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat mollitia, blanditiis inventore consectetur autem repudiandae quam, magni necessitatibus repellendus ducimus suscipit.</p>
